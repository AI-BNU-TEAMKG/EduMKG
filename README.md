...
|----------------------|--------------------------------------------------------------------------------------------|----------------------------------------------------------|
| Knowledge Point      | A Knowledge point is unique and structured knowledge unit within a discipline, serving as key node connecting related concepts, exercises, and other knowledge points. | KP = \{ id, name, associated\_concepts, associated\_knowledge_points \}        |
